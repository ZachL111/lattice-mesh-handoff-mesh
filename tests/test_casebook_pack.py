"""Regression checks for the lattice-mesh-handoff-mesh casebook."""
...
from casebook.harness import assert_expected, lattice_mesh_handoff_mesh_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(lattice_mesh_handoff_mesh_summary(), assert_expected())
